...
public class TrafficStatInfo {
    ...
    public TrafficStatInfo(String lat, String lng, String state1, String state2, String state3, String state4, String state5, String state6, String state7, String state8, String state9, String state10, String state11, String state12, String state13, String state14, String state15) {
        this.lat = lat;
        this.lng = lng;
        this.state1 = state1;
        this.state2 = state2;
