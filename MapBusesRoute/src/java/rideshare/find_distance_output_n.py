...
cur.execute("SELECT d.rideid, d.sourcell, d.destinationll, d.destination, d.source, u.sex, d.pref FROM ridedata d, userdata u where d.done<>'Yes' and d.timestamp between '"+tsl+"'and '"+tsu+"' and d.userid <> '"+sys.argv[1]+"' and d.rideid<>'"+sys.argv[6]+"'")
...
# Use all the SQL you like
#cur.execute("SELECT d.rideid, d.sourcell, d.destinationll, d.destination, d.source, u.sex, d.pref FROM ridedata d, userdata u where d.done<>'Yes' and d.userid=u.userid and d.userid <> '"+sys.argv[1]+"'")
dl=[]
