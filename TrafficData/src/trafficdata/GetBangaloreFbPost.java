...
public class GetBangaloreFbPost {
    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            while (true) {
                ...
                long since = currentL - 1200;
                //System.out.println(currentL / 1000);
                String url_d = "https://graph.facebook.com/147207215344994/feed?since=" + since + "&until=" + currentL + "&access_token=CAAMFiSDA43ABAEr1dedHZCZBRvYWLKH7SffZB6vCZAffpPUsYdRz3HQ7kie0BQrxOEbin8Hx7sfAoyPZBGMdhKky0LtleOiVFTAQOAE3uS5V1JoJLYm8glIvLtsreF7uZCgZBT1k53CGDLuShmrh5KQLif6ZAlcsdOhvSym14NZBuz5FatHX5XonwdUZB5nzQc5ckZD";
                ...
                for (int i = 0; i < arr1.size(); i++) {
                    ...
                    if (!fromId.equals("147207215344994")) {
                        FileWriter complaintsWrite = new FileWriter("C:\\Users\\Server\\Documents\\facebookData\\Bangalore\\Complaints.txt", true);
                    ...
                    if (fromId.equals("147207215344994")) {
                        ...
                        while (st.hasMoreTokens()) {
                            ...
                            if ((ele.startsWith("LO") || ele.startsWith("PER") || ele.startsWith("ORG")) && (temp.startsWith("avoid")) || (temp.startsWith("due")) || (temp.startsWith("traffic"))) {
                                ...
                                FileWriter dataWrite = new FileWriter("C:\\Users\\Server\\Documents\\facebookData\\Bangalore\\JustData.txt", true);
                                FileWriter trafficWrite = new FileWriter("C:\\Users\\Server\\Documents\\facebookData\\Bangalore\\TrafficData.txt", true);
                                ...
                                String address = ele.trim() + ",Bangalore";
                ...
                Thread.sleep(1200 * 1000);//in miliseconds
            }
        } catch (Exception ex) {
